...
На этой странице перечислены конкретные коды ошибок, которые могут возникнуть при переводах EFT в турецкие банки. Каждая ошибка включает в себя `messageCode`, возвращаемый API, и описание или рекомендуемое действие.
