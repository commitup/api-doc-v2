...
Use this endpoint to validate the transfer payload and ensure the recipient's electronic wallet can accept the transfer.
...
| toWalletId | Yes | string | 50 | Wallet ID from [Wallet List](./wallet-list). |
...
| walletHolderName | string | Masked name of the wallet holder verifying the destination. |
