...
export const codes = [
  ...
  { code: "UNEXPECTED_SYSTEM_ERROR", description: "406 - BUSINESS ERROR", action: "Unhandled exception, send the order again." },
  { code: "INTERNAL_SERVER_ERROR", description: "500 - SERVER ERROR", action: "Unexpected exception, send the order again." },
