...
| currency | Yes | string | 3 | Three-letter ISO 4217 currency code (e.g., `USD`). |
| toCountryCode | Yes | string | 3 | Destination country (ISO 3166-1 alpha-3). |
| cardNumber | Yes | string | 34 | The 16-digit primary account number (PAN) of the receiving card. |
| apiAgentTxnRefNo | Yes | string | 50 | Unique reference ID generated by your system. |
| comment | No | string | 250 | Optional comment for the transaction. |
...
| relationshipWithSenderId | No | number | - | Relationship to recipient. See [Relationship List](../../resources/commons/relationship-with-sender). |
