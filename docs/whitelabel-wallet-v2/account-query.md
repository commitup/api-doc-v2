...
Check the status of a previously confirmed account transfer transaction. Use this endpoint to poll for updates if the transaction status is still in progress, or to recover state after a network timeout during the confirm request.
